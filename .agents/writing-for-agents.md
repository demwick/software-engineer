...
<!--
  Verbatim copy of an MIT-licensed reference, kept here because this repo's
  product is prompts. Not covered by the repository's AGPL header rule —
  see Hard Rule 7 in CLAUDE.md. Only internal links were repaired for the
  rename; the prose is unmodified.
-->
...
When the document you're writing is a skill, read [`writing-for-agents-skill-mechanics.md`](writing-for-agents-skill-mechanics.md) for frontmatter, invocation choice, and router skills.
...
- **By invocation** — skill-specific: see [`writing-for-agents-skill-mechanics.md`](writing-for-agents-skill-mechanics.md).
